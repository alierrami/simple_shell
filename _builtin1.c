 ...
 */
int _unset_alias(_info_t *info, char *str)
{
	char *p, c;
	int ret;
 ...
 * Return: Always 0 on success, 1 on error
 */
int _set_alias(_info_t *info, char *str)
{
	char *p;
